...
class _ProfilePageState extends State<ProfilePage> {
  ...
  String _joinedText = '';
  String _mbtiLabel = 'UNKNOWN';
  String _tagline = 'Personality Type';
  String _quote = 'Selesaikan tes MBTI untuk melihat ringkasan kepribadianmu.';
  String? _profilePictureUrl;
  Map<String, double> _indicators = const {};
  ...
  Future<void> _loadProfile() async {
    ...
    try {
      ...
      final profile = await SupabaseService.instance.getUserProfile(authUser.id);
      ...
      // 3. Baca mbti_type dari `users`, handle kasus string 'NULL'
  ...
  /// Hitung persentase dari score_* karena tabel `results` tidak menyimpan persen.
  /// Menampilkan semua 8 dimensi MBTI.
  Map<String, double> _indicatorsFromResult(Map<String, dynamic>? result) {
    if (result == null) return const {};
    ...
    // Jika semua score 0, belum ada data yang valid
                  ...
                  children: [
                    ...
                    Card(
                      ...
                      child: Column(
                        children: [
                          ListTile(
                            leading: const Icon(Icons.history, color: _primaryColor),
                            title: const Text('History / Riwayat Tes'),
                            subtitle: const Text('Lihat hasil tes sebelumnya'),
                            trailing: const Icon(Icons.chevron_right),
                            onTap: () {},
                          ...
                          const Divider(height: 1),
                          ListTile(
                            leading: const Icon(Icons.favorite, color: _primaryColor),
                            title: const Text('Compatibility / Kecocokan Teman'),
                            subtitle: Text(
                              _mbtiLabel != 'UNKNOWN'
                                  ? 'Lihat tipe yang cocok dengan $_mbtiLabel'
                                  : 'Selesaikan tes untuk melihat kecocokan',
                          ...
                          ListTile(
                            ...
                            title: const Text('Settings / Pengaturan'),
                            subtitle: const Text('Akun, notifikasi, dan keluar'),
                            trailing: const Icon(Icons.chevron_right),
                            onTap: () {},
                          ),
                        ],
